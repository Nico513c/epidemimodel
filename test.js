...
function draw() {
  ...
  talPlot.fillText("Infected: " + syge,10,35)
  talPlot.fillText("Healthy: " + raske,10,55)
  talPlot.fillText("Recovered: " + (dead+immune),10,75)
  talPlot.fillText("Immune: " + immune,10,95)
  talPlot.fillText("Døde: " + dead,10,115)
